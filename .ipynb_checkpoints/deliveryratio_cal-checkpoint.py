...
TA_DB_PATH = os.path.join(BASE_DIR_db, "deliveryavg.db")

# Define the file containing stock symbols
#INPUT_FILE = '/Users/shail/Documents/Trading/NiftyStocks/niftyallmarket_symbol'
INPUT_FILE =  os.path.join(BASE_DIR, "NiftyStocks","niftyallmarket_symbol")
...
query = f"SELECT * FROM nsestock_t ORDER BY Date DESC"
